    ...
    if (number == 0 ){
        ...
        if (isPrime == true){    
            ...
            if(originalNumber == temp){
                console.log("given number is prime & palindrome")
            }else{ 
                console.log("given number is prime but not palindrome")
            }
            ...
            if(originalNumber == temp){
                console.log("given number is  not prime but palindrome")
            }else{ 
                console.log("given number is nither prime nor palindrome")
            }
        }
    }
}
